...
class SciCamera():
	...
	## @~chinese
	#  @brief Ô­Ê¼Êý¾Ý»Øµ÷º¯ÊýÀàÐÍ¶¨Òå
	#  @details ÓÃÓÚ×¢²áÍ¼ÏñÊý¾Ý»òÂÖÀªÊý¾ÝµÄ»Øµ÷º¯Êý
	#  @param payload [IN] ²É¼¯µ½µÄpayloadÊý¾Ý£¬¿ÉÒÔÊÇÍ¼ÏñÊý¾Ý»òÂÖÀªÊý¾Ý
	#  @param tag [IN] ÓÃ»§×Ô¶¨Òå²ÎÊý£¬ÓÃÓÚ´«µÝÓÃ»§Êý¾Ý
	#  @retval NULL
	#  @remarks ¸Ãº¯ÊýÀàÐÍÓÃÓÚSciCam_RegisterPayloadCallBack½Ó¿Ú
	#  @~english
	...
	#  @brief »ñÈ¡SDK°æ±¾ºÅ
	#  @param NULL
	#  @retval ·µ»Ø4×Ö½Ú°æ±¾ºÅ:
	#  | Ö÷°æ±¾ | ´Î°æ±¾ | ÐÞÕý°æ±¾ | ²âÊÔ°æ±¾ |
	#  | --- | --- | --- | --- |
	#  | 8bits | 8bits | 8bits | 8bits |
	#  @remarks ÀýÈç·µ»ØÖµÎª0x01000001£¬¼´SDK°æ±¾ºÅÎªV1.0.0.1
	#  @~english
	...
	## @ingroup module_Other
	#  @~chinese
	#  @brief ÉèÖÃSDKÈÕÖ¾Êä³öÂ·¾¶
	#  @param logPath [IN] ÎÄ¼þ¼ÐÂ·¾¶(¾ø¶ÔÂ·¾¶)
	#  @retval ³É¹¦£º@ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û£º@ref SciCamErrorDefine_const "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @~chinese
	#  @brief ËÑË÷Éè±¸
	#  @param devInfos [OUT] ËÑË÷µ½µÄÉè±¸ÁÐ±í£¬ÏêÇé²Î¿¼£º@ref PSCI_DEVICE_INFO_LIST "PSCI_DEVICE_INFO_LIST"
	#  @param tlType [IN] ´«Êä²ãÀàÐÍ×éºÏ£¨0£ºËÑË÷È«²¿£¬ÆäËûÈçSciCam_TLType_Gige | SciCam_TLType_Usb3 ½öËÑË÷GigEºÍUSB3.0Éè±¸£©
	#  @retval ³É¹¦£º@ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û£º@ref SciCamErrorDefine_const "×´Ì¬Âë"
	#  @remarks µ±tlTypeÎªSciCam_TLType_CL_CAM_ONLYÊ±£¬½öËÑË÷CL²É¼¯¿¨ÏÂµÄÏà»ú¡£SciCam_TLType_CL_CAM_ONLY²»ÄÜÓëÆäËûtlType½øÐÐ»ò²Ù×÷
	#  @~english
	...
	#  @~chinese
	#  @brief ´´½¨Ïà»ú¾ä±ú
	#  @param devInfo [IN] Éè±¸ÐÅÏ¢½á¹¹Ìå£¬ÏêÇé²Î¿¼£º@ref PSCI_DEVICE_INFO "PSCI_DEVICE_INFO"
	#  @retval ³É¹¦£º@ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û£º@ref SciCamErrorDefine_const "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @~chinese
	#  @brief ×¢²áÉè±¸¼àÌýÊÂ¼þ
	#  @param hDev		[IN] Éè±¸¾ä±ú
	#  @param fn		[IN] »Øµ÷º¯ÊýÖ¸Õë
	#  @param tag		[IN] ÓÃ»§×Ô¶¨Òå²ÎÊý
	#  @retval NULL
	#  @remarks Í¨¹ý×¢²á»Øµ÷·½Ê½£¬¿ÉÊµÊ±»ñÈ¡µ½Ïà»úÉÏÏß¡¢ÀëÏßµÈÍ¨ÖªÏûÏ¢
	#  @~english
	...
	#  @remarks ¶ÔÓÚGigEºÍU3VÉè±¸Îª´ò¿ªÏà»ú£¬CLÉè±¸Îª´ò¿ª²É¼¯¿¨£¬¿É²Î¿¼SciCam_CL_OpenCam
	#  @~english
	#  @brief Open Device
	...
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Í¨¹ýSciCam_OpenDeviceÁ¬½ÓÉè±¸ºó£¬¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú¶Ï¿ªÉè±¸Á¬½Ó£¬ÊÍ·Å×ÊÔ´¡£Èç¹ûÊÇCLÉè±¸£¬¹Ø±Õ²É¼¯¿¨Ê±»á°Ñ²É¼¯¿¨ÏÂµÄËùÓÐÏà»úÒ»Æð¹Ø±Õ
	#  @~english
	#  @brief Close Device
	#  @param hDev	[IN]  Device handle
	#  @retval Success: @ref SCI_CAMERA_OK "SCI_CAMERA_OK"
	...
	## @ingroup module_DeviceInitAndDestr
	#  @~chinese
	#  @brief ÅÐ¶ÏÉè±¸ÊÇ·ñÒÑÁ¬½Ó
	#  @param hDev	[IN]  Éè±¸¾ä±ú
	#  @retval true: Éè±¸ÒÑÁ¬½Ó£»false£ºÉè±¸Î´Á¬½Ó
	#  @remarks ¶ÔÓÚGigEºÍU3VÉè±¸ÎªÏà»úÊÇ·ñÒÑÁ¬½Ó£¬¶ÔÓÚCLÉè±¸Îª²É¼¯¿¨ÊÇ·ñÒÑÁ¬½Ó£¬¿É²Î¿¼SciCam_CL_IsCamOpen
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief ×¢²áÔ­Ê¼Êý¾Ý£¨Í¼ÏñÊý¾Ý/ÂÖÀªÊý¾Ý£©»Øµ÷
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param fn		[IN]  »Øµ÷º¯ÊýÖ¸Õë
	#  @param tag		[IN]  ×Ô¶¨Òå²ÎÊý
	#  @param autoFree	[IN]  »Øµ÷Ö´ÐÐÍêÊÇ·ñÊÍ·Åpayload£¬trueÎªÊÍ·Å£¬falseÎª²»ÊÍ·Å£¨ÊÖ¶¯ÊÍ·Åpayload¿É²Î¿¼£ºSciCam_FreePayload£©
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Í¨¹ý¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃÍ¼ÏñÊý¾Ý»òÂÖÀªÊý¾Ý»Øµ÷º¯Êý£¬ÔÚµ÷ÓÃSciCam_CreateDeviceÖ®ºó¼´¿ÉÊ¹ÓÃ¡£ \n
	#  		²É¼¯Í¼ÏñÊý¾Ý»òÂÖÀªÊý¾ÝÓÐÁ½ÖÖ·½Ê½£º \n
	#  		·½Ê½Ò»£ºµ÷ÓÃSciCam_RegisterPayloadCallBackÉèÖÃ»Øµ÷º¯Êý£¬È»ºóµ÷ÓÃSciCam_StartGrabbing¿ªÊ¼²É¼¯£¬²É¼¯µÄÍ¼Ïñ/ÂÖÀªÊý¾ÝÔÚÉèÖÃµÄ»Øµ÷º¯ÊýÖÐ·µ»Ø¡£ \n
	#  		·½Ê½¶þ£ºµ÷ÓÃSciCam_StartGrabbing¿ªÊ¼²É¼¯£¬È»ºóÔÚÓ¦ÓÃ²ãÑ­»·µ÷ÓÃSciCam_Grab»ñÈ¡µÃµ½Í¼Ïñ/ÂÖÀªÊý¾Ý¡£ \n
	#  		²ÉÓÃ·½Ê½¶þ»ñÈ¡payloadÊý¾ÝÊ±£¬Ó¦ÓÃ²ãÐè¸ù¾ÝÖ¡ÂÊ¿ØÖÆºÃµ÷ÓÃ¸Ã½Ó¿ÚµÄÆµÂÊ¡£
	#  		»ñÈ¡µ½µÄpayloadÊý¾Ý¿ÉÍ¨¹ýSciCamPayload.hÖÐÏàÓ¦µÄ½Ó¿Ú»ñÈ¡µ½payloadÏà¹ØÊôÐÔ£¬×ª»»³ÉËùÐèÊý¾Ý¸ñÊ½¡£
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief »ñÈ¡µ±Ç°Éè±¸²É¼¯²ßÂÔ
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param pStrategy	[OUT] »ñÈ¡µ½µÄ²É¼¯²ßÂÔ£¬ÏêÏ¸²Î¿¼£º @ref SciCamGrabStrategy "SciCamGrabStrategy"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @brief ÉèÖÃ²É¼¯²ßÂÔ
	#  @param hDev			[IN] Éè±¸¾ä±ú
	#  @param grabStrategy	[IN] ²É¼¯²ßÂÔ£¬ÏêÏ¸²Î¿¼£º @ref SciCamGrabStrategy "SciCamGrabStrategy"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief »ñÈ¡µ±Ç°Éè±¸²É¼¯Ò»Ö¡µÄµÈ´ý³¬Ê±Ê±¼ä
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param pTimeout	[OUT] »ñÈ¡µ½µÄµÈ´ý³¬Ê±Ê±¼ä£¨µ¥Î»£ºms£©
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks ²É¼¯Ê±²ÉÓÃµÄÊÇ³¬Ê±µÈ´ý»úÖÆ£¬Èç¹ûÔÚ³¬Ê±µÈ´ýÊ±¼äÄÚÎ´Íê³É²É¼¯ÍêÕûÒ»Ö¡»òµÈ´ý³¬¹ý³¬Ê±Ê±¼äÒ²Ã»²É¼¯µ½Ò»Ö¡£¬Ôò»á·µ»Ø´íÎóÂë£¬ÇëºÏÀíÉèÖÃµÈ´ý³¬Ê±Ê±¼ä
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief ÉèÖÃµ±Ç°Éè±¸²É¼¯Ò»Ö¡ËùÐèµÄµÈ´ý³¬Ê±Ê±¼ä
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param timeout	[IN]  µÈ´ý³¬Ê±Ê±¼ä£¨µ¥Î»£ºms£©
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks ²É¼¯Ê±²ÉÓÃµÄÊÇ³¬Ê±µÈ´ý»úÖÆ£¬Èç¹ûÔÚ³¬Ê±µÈ´ýÊ±¼äÄÚÎ´Íê³É²É¼¯ÍêÕûÒ»Ö¡»òµÈ´ý³¬¹ý³¬Ê±Ê±¼äÒ²Ã»²É¼¯µ½Ò»Ö¡£¬Ôò»á·µ»Ø´íÎóÂë£¬ÇëºÏÀíÉèÖÃµÈ´ý³¬Ê±Ê±¼ä
	#  @~english
	...
	#  @param hDev		[IN]  Device handle
	#  @param timeout	[IN]  Timeout waiting time£¨unit£ºms£©
	#  @retval Success: @ref SCI_CAMERA_OK "SCI_CAMERA_OK"
	#  @retval Other references: @ref SciCamErrorDefine.h "Error Code List"
	#  @remarks During capture, a timeout waiting mechanism is used. If capturing a complete frame is not completed within the timeout waiting time or if no frame is captured within the specified timeout, an error code will be returned. Please set the timeout waiting time appropriately.
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief »ñÈ¡²É¼¯Ê±»º´æ¶ÓÁÐ´óÐ¡
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param pBufferCount	[OUT] »ñÈ¡µ½µÄ»º´æ¶ÓÁÐ´óÐ¡
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks »º´æ¶ÓÁÐÔ½´óÔ½ÏûºÄ×ÊÔ´£¬µ«Í¬Ê±Ò²ÄÜ¼õÉÙ¶ªÖ¡¸ÅÂÊ£¬ÇëºÏÀí·ÖÅä»º´æ¶ÓÁÐ´óÐ¡
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief ÉèÖÃ²É¼¯Ê±»º´æ¶ÓÁÐ´óÐ¡
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param pBufferCount	[IN]  »º´æ¶ÓÁÐ´óÐ¡
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks »º´æ¶ÓÁÐÔ½´óÔ½ÏûºÄ×ÊÔ´£¬µ«Í¬Ê±Ò²ÄÜ¼õÉÙ¶ªÖ¡¸ÅÂÊ£¬ÇëºÏÀí·ÖÅä»º´æ¶ÓÁÐ´óÐ¡¡£ \n
	#  			bufferCountÎª0Ê±±íÊ¾²»ÉèÖÃ£¬Ê¹ÓÃÍÆ¼ö»º´æ²ßÂÔ¡£
	#  @~english
	#  @brief Retrieve the size of the buffer queue during grabbing
	#  @param hDev			[IN]  Device handle
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief ²É¼¯Ò»Ö¡Êý¾Ý£¨Í¼ÏñÊý¾Ý/ÂÖÀªÊý¾Ý£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param ppayload	[OUT] Ò»Ö¡µÄÊý¾Ý
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks µ÷ÓÃSciCam_RegisterPayloadCallBack½Ó¿Ú×¢²á»Øµ÷ºóÓë¸Ã½Ó¿Ú²»¼æÈÝ£¬Çë¶þÈ¡ÆäÒ»Ê¹ÓÃ¡£ \n
	#  		»ñÈ¡µ½µÄpayloadÊý¾Ý¿ÉÍ¨¹ýSciCamPayload.hÖÐÏàÓ¦µÄ½Ó¿Ú»ñÈ¡µ½payloadÏà¹ØÊôÐÔ£¬×ª»»³ÉËùÐèÊý¾Ý¸ñÊ½¡£ \n
	#  		Ö¡Êý¾ÝÊ¹ÓÃÍêºóÇëµ÷ÓÃSciCam_FreePayload½øÐÐÊÍ·Å£¬±ÜÃâÉè±¸ÎÞ·¨¼ÌÐø²É¼¯µÄÇé¿ö¡£
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief ÊÍ·ÅÒ»Ö¡Êý¾Ý£¨Í¼ÏñÊý¾Ý/ÂÖÀªÊý¾Ý£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param payload	[IN]  Ò»Ö¡µÄÊý¾Ý
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡¿í¶ÈÐÅÏ¢ÔòÎª"Width"
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_INT "PSCI_NODE_VAL_INT"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡intÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IInteger¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´»ñÈ¡Ïà»úÉè±¸XMLÖÐ¡°IInteger¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_GetIntValueEx
	#  @~english
	...
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡¿í¶ÈÐÅÏ¢ÔòÎª"Width"
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃintÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IInteger¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°IInteger¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetIntValueEx
	#  @~english
	...
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_FLOAT "PSCI_NODE_VAL_FLOAT"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡floatÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IFloat¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£
	#  		´Ë½Ó¿Ú½öÓÃÀ´»ñÈ¡Ïà»úÉè±¸XMLÖÐ¡°IFloat¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_GetFloatValueEx
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃfloatÐÍÊôÐÔÖµ
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃfloatÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IFloat¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°IFloat¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetFloatValueEx
	#  @~english
	...
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔÖµ
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡boolÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IBoolean¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´»ñÈ¡Ïà»úÉè±¸XMLÖÐ¡°IBoolean¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_GetBoolValueEx
	#  @~english
	...
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃboolÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£strKeyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IBoolean¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬strKey²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°IBoolean¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetBoolValueEx
	#  @~english
	...
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_STRING "PSCI_NODE_VAL_STRING"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡stringÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£KeyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IString¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´»ñÈ¡Ïà»úÉè±¸XMLÖÐ¡°IString¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_GetStringValueEx
	#  @~english
	...
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃstringÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£KeyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IString¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°IString¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetStringValueEx
	#  @~english
	...
	#  @brief »ñÈ¡EnumÊôÐÔÖµ
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡ÏñËØ¸ñÊ½ÐÅÏ¢ÔòÎª"PixelFormat"
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_ENUM "PSCI_NODE_VAL_ENUM"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡EnumÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IEnumeration¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´»ñÈ¡Ïà»úÉè±¸XMLÖÐ¡°IEnumeration¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_GetEnumValueEx
	#  @~english
	...
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃEnumÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IEnumeration¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°IEnumeration¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetEnumValueEx
	#  @~english
	...
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡ÏñËØ¸ñÊ½ÐÅÏ¢ÔòÎª"PixelFormat"
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔ×Ö·û´®
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃEnumÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IEnumeration¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°IEnumeration¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetEnumValueByStringEx
	#  @~english
	#  @brief Set Enum value
	#  @param hDev		[IN]  Device handle
	#  @param key		[IN]  Key value, for example, using "PixelFormat" to set pixel format
	...
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃÖ¸¶¨µÄCommandÀàÐÍ½Úµã¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°ICommand¡±µÄ½Úµã¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		´Ë½Ó¿Ú½öÓÃÀ´ÉèÖÃÏà»úÉè±¸XMLÖÐ¡°ICommand¡±ÀàÐÍ½ÚµãÖµ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£ºSciCam_SetCommandValueEx
	#  @~english
	...
	#  @brief Ã¶¾Ù½Úµã¼¯ºÏ
	#  @param hDev			[IN]      Éè±¸¾ä±ú
	#  @param nodes			[IN][OUT] ½Úµã¼¯£¬ÏêÏ¸²Î¿¼£º @ref PSCI_CAM_NODE "PSCI_CAM_NODE"
	#  @param nodesCount	[IN][OUT] ½Úµã¸öÊý
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks »ñÈ¡µ±Ç°Á¬½ÓµÄÉè±¸ËùÓÐ½Úµã¼¯ºÏ£¬µ±nodes²ÎÊýÎª¿ÕÊ±£¬Ä¬ÈÏÖ»·µ»Øµ±Ç°½Úµã¸öÊý
	#  @~english
	...
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param key			[IN]  ÊôÐÔ¼üÖµ
	#  @param pType			[OUT] ½ÚµãÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeType "SciCamNodeType"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡½ÚµãÃüÃû¿Õ¼ä
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param key			[IN]  ÊôÐÔ¼üÖµ
	#  @param pNameSpace	[OUT] ½ÚµãÃüÃû¿Õ¼ä£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeNameSpace "SciCamNodeNameSpace"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param key			[IN]  ÊôÐÔ¼üÖµ
	#  @param pVisibility	[OUT] ½Úµã¿É¼ûÐÔ£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeVisibility "SciCamNodeVisibility"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param key			[IN]  ÊôÐÔ¼üÖµ
	#  @param pAccessMode	[OUT] ½Úµã·ÃÎÊÄ£Ê½£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeAccessMode "SciCamNodeAccessMode"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @~chinese
	#  @brief µ¼³öÏà»úÊôÐÔµ½±¾µØXMLÎÄ¼þ
	#  @param hDev			[IN]      Éè±¸¾ä±ú
	#  @param strFileName	[IN]      XMLÎÄ¼þÃû
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ½«Éè±¸ÊôÐÔµ¼³öµ½±¾µØXMLÎÄ¼þ£¬strFileNameÎªµ¼³öÎÄ¼þµÄÂ·¾¶ºÍÃû³Æ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£º@ref SciCam_FeatureSaveEx "SciCam_FeatureSaveEx"
	#  @~english
	...
	## @ingroup module_DeviceAttributeManipulation
	#  @~chinese
	#  @brief ´Ó±¾µØXMLÎÄ¼þµ¼ÈëÏà»úÊôÐÔ
	#  @param hDev			[IN]      Éè±¸¾ä±ú
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ½«±¾µØXMLÎÄ¼þµ¼ÈëÉè±¸ÊôÐÔ£¬strFileNameÎªµ¼ÈëÎÄ¼þµÄÂ·¾¶ºÍÃû³Æ£¬CLºÍCXPÉè±¸Çë²Î¿¼½Ó¿Ú£º@ref SciCam_FeatureLoadEx "SciCam_FeatureLoadEx"
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡IntegerÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡¿í¶ÈÐÅÏ¢ÔòÎª"Width"
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_INT "PSCI_NODE_VAL_INT"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡intÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IInteger¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿É»ñÈ¡Éè±¸XMLÖÐ¡°IInteger¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃIntegerÐÍÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡¿í¶ÈÐÅÏ¢ÔòÎª"Width"
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃintÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IInteger¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿ÉÉèÖÃÉè±¸XMLÖÐ¡°IInteger¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡FloatÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_FLOAT "PSCI_NODE_VAL_FLOAT"
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡floatÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IFloat¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿É»ñÈ¡Éè±¸XMLÖÐ¡°IFloat¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃfloatÐÍÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃfloatÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IFloat¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿ÉÉèÖÃÉè±¸XMLÖÐ¡°IFloat¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡BooleanÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔÖµ
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡boolÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IBoolean¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿É»ñÈ¡Éè±¸XMLÖÐ¡°IBoolean¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃBooleanÐÍÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃboolÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£strKeyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IBoolean¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬strKey²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿ÉÉèÖÃÉè±¸XMLÖÐ¡°IBoolean¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡StringÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡stringÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£KeyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IString¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿É»ñÈ¡Éè±¸XMLÖÐ¡°IString¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃStringÐÍÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN] Éè±¸¾ä±ú
	#  @param xmlType	[IN] XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN] ÊôÐÔ¼üÖµ
	#  @param val		[IN] ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃstringÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£KeyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IString¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿ÉÉèÖÃÉè±¸XMLÖÐ¡°IString¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡EnumÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡ÏñËØ¸ñÊ½ÐÅÏ¢ÔòÎª"PixelFormat"
	#  @param pVal		[OUT] ·µ»Ø¸øµ÷ÓÃÕßÓÐ¹ØÉè±¸ÊôÐÔ½á¹¹ÌåÖ¸Õë£¬ÏêÏ¸²Î¿¼£º @ref PSCI_NODE_VAL_ENUM "PSCI_NODE_VAL_ENUM"
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ»ñÈ¡EnumÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IEnumeration¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿Ú»ñÈ¡£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿É»ñÈ¡Éè±¸XMLÖÐ¡°IEnumeration¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃEnumÐÍÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ£¬Èç»ñÈ¡ÏñËØ¸ñÊ½ÐÅÏ¢ÔòÎª"PixelFormat"
	#  @param val		[IN]  ÏëÒªÉèÖÃµÄÉè±¸µÄÊôÐÔÖµ
	...
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔÉèÖÃEnumÀàÐÍµÄÖ¸¶¨½ÚµãµÄÖµ¡£keyÈ¡Öµ¿ÉÒÔ²Î¿¼XML½Úµã²ÎÊýÀàÐÍÁÐ±í£¬±í¸ñÀïÃæÊý¾ÝÀàÐÍÎª¡°IEnumeration¡±µÄ½ÚµãÖµ¶¼¿ÉÒÔÍ¨¹ý¸Ã½Ó¿ÚÉèÖÃ£¬key²ÎÊýÈ¡Öµ¶ÔÓ¦ÁÐ±íÀïÃæµÄ¡°Ãû³Æ¡±Ò»ÁÐ¡£ \n
	#  		¸ù¾Ý²»Í¬XMLÀàÐÍ¿ÉÉèÖÃÉè±¸XMLÖÐ¡°IEnumeration¡±ÀàÐÍ½ÚµãÖµ£¬±ÈÈçCL²É¼¯¿¨£¬xmlTypeÎªSciCamDeviceXmlType::SciCam_DeviceXml_Card
	#  @~english
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief ÉèÖÃCommandÐÍÊôÐÔÖµ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	...
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks »ñÈ¡µ±Ç°Á¬½ÓµÄÉè±¸ËùÓÐ½Úµã¼¯ºÏ
	#  @~english
	#  @brief Set Command value by xml type
	#  @param hDev			[IN]      Device handle
	#  @param xmlType		[IN]      XML type, references: @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡½ÚµãÀàÐÍ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pType		[OUT] ½ÚµãÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeType "SciCamNodeType"
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡½ÚµãÃüÃû¿Õ¼ä£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pNameSpace	[OUT] ½ÚµãÃüÃû¿Õ¼ä£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeNameSpace "SciCamNodeNameSpace"
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡½Úµã¿É¼ûÐÔ£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pVisibility	[OUT] ½Úµã¿É¼ûÐÔ£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeVisibility "SciCamNodeVisibility"
	...
	## @ingroup module_Node
	#  @~chinese
	#  @brief »ñÈ¡½Úµã·ÃÎÊÄ£Ê½£¨¸ù¾Ý²»Í¬XMLÀàÐÍ£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param xmlType	[IN]  XMLÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamDeviceXmlType "SciCamDeviceXmlType"
	#  @param key		[IN]  ÊôÐÔ¼üÖµ
	#  @param pAccessMode	[OUT] ½Úµã·ÃÎÊÄ£Ê½£¬ÏêÏ¸²Î¿¼£º @ref SciCamNodeAccessMode "SciCamNodeAccessMode"
	...
	## @ingroup module_DeviceAttributeManipulation
	#  @~chinese
	#  @brief µ¼³öÉè±¸ÊôÐÔµ½±¾µØXMLÎÄ¼þ
	#  @param hDev			[IN]      Éè±¸¾ä±ú
	#  @param xmlType		[IN]      XMLÎÄ¼þÀàÐÍ
	#  @param strFileName	[IN]      XMLÎÄ¼þÃû
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ½«±¾µØXMLÎÄ¼þµ¼³öÉè±¸ÊôÐÔ£¬strFileNameÎªµ¼³öÎÄ¼þµÄÂ·¾¶ºÍÃû³Æ£¬xmlTypeÎªÉè±¸ÀàÐÍ£¬Ö§³ÖCLºÍCXPÉè±¸
	#  @~english
	...
	## @ingroup module_DeviceAttributeManipulation
	#  @~chinese
	#  @brief ´Ó±¾µØXMLÎÄ¼þµ¼ÈëÉè±¸ÊôÐÔ
	#  @param hDev			[IN]      Éè±¸¾ä±ú
	#  @param xmlType		[IN]      XMLÎÄ¼þÀàÐÍ
	#  @param strFileName	[IN]      XMLÎÄ¼þÃû
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Á¬½ÓÉè±¸Ö®ºóµ÷ÓÃ¸Ã½Ó¿Ú¿ÉÒÔ½«±¾µØXMLÎÄ¼þµ¼ÈëÉè±¸ÊôÐÔ£¬strFileNameÎªµ¼ÈëÎÄ¼þµÄÂ·¾¶ºÍÃû³Æ£¬xmlTypeÎªÉè±¸ÀàÐÍ£¬Ö§³ÖCLºÍCXPÉè±¸
	#  @~english
	...
	## @ingroup module_Other
	#  @~chinese
	#  @brief ÉèÖÃGigEÉè±¸IP¡¢×ÓÍøÑÚÂëºÍÍø¹ØµØÖ·
	#  @param sn		[IN]  Éè±¸ÐòÁÐºÅ
	#  @param ip		[IN]  ipµØÖ·
	#  @param mask		[IN]  ×ÓÍøÑÚÂë
	#  @param gateway	[IN]  Íø¹Ø
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks
	#  @~english
	...
	#  @brief ÉèÖÃGigEÉè±¸IP¡¢×ÓÍøÑÚÂëºÍÍø¹ØµØÖ·
	#  @param sn		[IN]  Éè±¸ÐòÁÐºÅ
	#  @param ip		[IN]  ipµØÖ·£¬¸ñÊ½Îª×Ö·û´®£¬Èç"192.168.1.100"
	#  @param mask		[IN]  ×ÓÍøÑÚÂë£¬¸ñÊ½Îª×Ö·û´®£¬Èç"255.255.255.0"
	#  @param gateway	[IN]  Íø¹Ø£¬¸ñÊ½Îª×Ö·û´®£¬Èç"192.168.1.1"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks
	#  @~english
	...
	## @ingroup module_DeviceInitAndDestr
	#  @~chinese
	#  @brief ´ò¿ªCL²É¼¯¿¨Á¬½ÓµÄÏà»úÉè±¸
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Ö»ÄÜ¶ÔCL²É¼¯¿¨Á¬½ÓµÄÏà»ú½øÐÐ²Ù×÷
	#  @~english
	#  @brief Open the camera devices connected to the CL capture card.
	#  @param hDev		[IN]  Device handle
	#  @retval Success: @ref SCI_CAMERA_OK "SCI_CAMERA_OK"
	...
	## @ingroup module_DeviceInitAndDestr
	#  @~chinese
	#  @brief ÅÐ¶ÏCL²É¼¯¿¨ÖÐµÄÏà»úÊÇ·ñÒÑÁ¬½Ó
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks Ö»ÄÜ¶ÔCL²É¼¯¿¨ÏàÁ¬µÄÏà»ú½øÐÐ²Ù×÷
	#  @~english
	...
	## @ingroup module_Grab
	#  @~chinese
	#  @brief ÉèÖÃ²É¼¯ÀàÐÍ£¨3DÏßÉ¨¼¤¹âÂÖÀªÉè±¸£©
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param mode		[IN]  ²É¼¯ÀàÐÍ£¬ÏêÏ¸²Î¿¼£º @ref SciCamLp3dGrabMode "SciCamLp3dGrabMode"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @brief ¿ªÊ¼Â¼Ïñ
	#  @param hDev			[IN]  Éè±¸¾ä±ú
	#  @param recoredInfo	[IN]  Â¼ÏñÐÅÏ¢£¬ÏêÏ¸²Î¿¼£º @ref SCI_RECORD_INFO "SCI_RECORD_INFO"
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
	...
	#  @brief ´«ÈëÂ¼ÏñÊý¾Ý
	#  @param hDev		[IN]  Éè±¸¾ä±ú
	#  @param payload	[IN]  ²É¼¯µ½µÄpayloadÊý¾Ý
	#  @retval ³É¹¦£º @ref SCI_CAMERA_OK "SCI_CAMERA_OK"(0)
	#  @retval ÆäËû²Î¼û: @ref SciCamErrorDefine.h "×´Ì¬Âë"
	#  @remarks NULL
	#  @~english
