...
class SciCamera():
	...
	def SciCam_FeatureSave(self, xmlType, strFileName):
		SciCamCtrlDll.SciCam_FeatureSave.argtypes = (ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p)
		SciCamCtrlDll.SciCam_FeatureSave.restype = ctypes.c_uint
		return SciCamCtrlDll.SciCam_FeatureSave(self.handle, ctypes.c_int(xmlType), strFileName.encode('ascii'))
	...
	def SciCam_FeatureLoad(self, xmlType, strFileName):
		SciCamCtrlDll.SciCam_FeatureLoad.argtypes = (ctypes.c_void_p, ctypes.c_int, ctypes.c_void_p)
		SciCamCtrlDll.SciCam_FeatureLoad.restype = ctypes.c_uint
		return SciCamCtrlDll.SciCam_FeatureLoad(self.handle, ctypes.c_int(xmlType), strFileName.encode('ascii'))
